...
import com.juampamuralles.sessions.FacturasFacadeLocal;
...
public class FacturasController implements Serializable {
    ...
    @EJB
    private FacturasFacadeLocal ejbFacade;
    ...
    private FacturasFacadeLocal getFacade() {
        return ejbFacade;
    }
    ...
    public static class FacturasControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Facturas) {
                ...
                return getStringKey(o.getIdfacturas());
            } else {
